...
# ── Config ──────────────────────────────────────────────────────────────────
JUDGE_MODEL = "gpt-5"  # change to "gpt-4o" or whatever you have access to
...
def judge_response(client: OpenAI, prompt: str, response: str) -> str:
    """Ask GPT-5 to classify a single VLM response as MALIGNANT/BENIGN/AMBIGUOUS."""
    try:
...
def main():
    parser = argparse.ArgumentParser(description="Eval VLM histopath responses with GPT-5 as judge")
